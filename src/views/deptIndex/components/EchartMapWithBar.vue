<template>
    <v-chart class='cbg' :autoresize='true' :options='options' ref='echarts'/>
</template>
  ...
  mounted () {
    this.options = {
      ...
      series: [{
        ...
        geoIndex: 2,
        symbol: '/img/barMap.5ddda2ac.png',
        zlevel: 2,
        showAllSymbol: true,
        symbolSize: 100,
        label: {
        ...
        data: [{
          name: '北京',
          value: [116.46, 39.92, 199],
          symbol: 'image:///img/barMap.5ddda2ac.png',
          symbolSize: ['20', '50']
        }, {
          name: '天津',
          value: [117.2, 39.13, 42],
          symbol: 'image:///img/barMap.5ddda2ac.png',
          symbolSize: ['20', '50']
        }, {
          name: '吉林',
          value: [126.57, 43.87, 82],
          symbol: 'image:///img/barMap.5ddda2ac.png',
          symbolSize: ['20', '50']
        }, {
          name: '上海',
          value: [121.48, 31.22, 24],
          symbol: 'image:///img/barMap.5ddda2ac.png',
          symbolSize: ['20', '50']
        }, {
          name: '安徽',
          value: [117.27, 31.86, 109],
          symbol: 'image:///img/barMap.5ddda2ac.png',
          symbolSize: ['20', '50']
        }, {
          name: '重庆',
          value: [106.54, 29.59, 91],
          symbol: 'image:///img/barMap.5ddda2ac.png',
          symbolSize: ['20', '50']
        }, {
          name: '新疆',
          value: [87.68, 43.77, 180],
          symbol: 'image:///img/barMap.5ddda2ac.png',
          symbolSize: ['20', '50']
        }]
      }]
